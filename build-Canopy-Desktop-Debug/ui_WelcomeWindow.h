...
public:
    ...
    void setupUi(QMainWindow *WelcomeWindow)
    {
        ...
        warrantNumberField->setFont(font);
        ...
        QWidget::setTabOrder(suspectNameField, warrantNumberField);
        QWidget::setTabOrder(warrantNumberField, emailAddressField);
        QWidget::setTabOrder(emailAddressField, browseButton);
        QWidget::setTabOrder(browseButton, evaluateButton);
